...
@Slf4j
public class Servlets implements ServletContext {
    private final Map<String, ServletModel> servlets = new HashMap<>();
    ...
    public void putServlet(String servletName, ServletModel servletModel) {
        ...
        Server.servlets.servlets.put(servletName, servletModel);
        Server.servlets.registered.add(servletModel.getServletClazz());
    }

    public ServletModel getServletModel(String servletName) throws ServletException {
        ServletModel servletModel = Server.servlets.servlets.get(servletName);
    ...
    public boolean hasInstance(String servletName) {
        return Server.servlets.servlets.containsKey(servletName);
    }

    public String getClazzName(String servletName) throws ServletException {
        return Server.servlets.getServletModel(servletName).getServletClazz();
    }
    ...
    public boolean isRegistered(String servletClazz) {
        return Server.servlets.registered.contains(servletClazz);
    }
